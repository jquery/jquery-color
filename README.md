...
saturation( val ) // returns a copy of the color objec with the saturation set to val
lightness()       // returns the "lightness" component of the color ( Float from 0.0 - 1.0 )
lightness( val )  // returns a copy of the color objec with the lightness set to val
